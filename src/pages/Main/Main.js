                    ...
                    <div className="feeds">
                        ...
                        <article>
                            ...
                            <div className="article-icons">
                                <img alt= "heart icon" className="article-icon" src="../../images/heart.png" />
                                <img alt="comment icon" className="article-icon" src="../../images/speech-bubble.png" />
                                <img alt="share icon" className="article-icon" src="../../images/export.png" />
                                <img alt="bookmark icon" className="article-icon" src="../../images/bookmark.png" />
                            </div>
                            ...
                            <div className="comments-box">
                                <input id="comments-input" type="text" placeholder="댓글 달기..." />
                                <button id="comments-button" disabled>게시</button>
                            </div>
                        </article>
                    </div>
